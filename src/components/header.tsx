  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled ? "glass-strong border-b border-border/50 shadow-lg" : "bg-transparent"
      }`}
    >
      <div className="container mx-auto px-4 lg:px-6 py-3">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* GitHub Link */}
            <Button variant="ghost" size="sm" asChild className="hidden sm:flex hover:bg-accent/50">
              <a
            ...
            <Button
              ...
              size="sm"
              asChild
              className="relative overflow-hidden group border-primary/20 hover:border-primary/40 hover:bg-primary/5 bg-transparent"
            >
