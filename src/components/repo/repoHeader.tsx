...
//   };
//   return (
//     <div className=" py-3 px-6 flex items-center justify-between  rounded-xl  bg-white text-gray-700 my-6">
...
//           <Link href={repo.owner.html_url}  className=" hover:text-blue-400">
//             {repo.owner.login}
//           </Link>
...
//         {/* Fork Button Group */}
//         <div className="flex rounded-lg overflow-hidden border text-white border-gray-700">
...
export default function RepoActionBar({ repo }: Props) {
  ...
  return (
    <div className="py-3 px-4 sm:px-6 md:px-8 flex flex-col md:flex-row md:items-center justify-between rounded-xl bg-white text-gray-700 my-6 gap-4 md:gap-0">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-3 w-full md:w-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 truncate">
          ...
          {/* Public Badge */}
          <span className="text-xs sm:text-sm font-medium text-gray-400 border border-gray-700 rounded-full px-2 py-0.5 whitespace-nowrap w-fit">
            Public
          </span>
        </div>
      </div>
