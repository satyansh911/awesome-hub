...
//       <h2 className="text-xl font-semibold text-gray-700 flex items-baseline gap-2">
//         Contributors
...
//             target="_blank"
//             className="text-blue-500 hover:text-blue-300 transition-colors text-sm font-medium"
//           >
