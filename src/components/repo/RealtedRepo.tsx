...
import { Star, GitFork, GitCommit } from "lucide-react"; // Icons for stars, forks, and maybe an activity indicator
      ...
      <div className="space-y-3">
        {reposToShow.map((r) => (
          <Link
            ...
            className="block p-3 rounded-lg hover:bg-gray-800 transition-colors duration-200 border border-transparent hover:border-gray-700 group" // Added group for hover effects
          >
            <div className="flex items-center justify-between mb-1">
              {/* Repository Name */}
              <h3 className="font-semibold text-blue-400 group-hover:text-blue-300 text-base truncate pr-2">
